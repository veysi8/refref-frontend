...
import { MapPin, Maximize, BedDouble, Bath, Calendar, Building, Heart, MessageCircle } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              ...
              <div>
                ...
                <APIProvider apiKey={GOOGLE_MAPS_API_KEY}>
                  <div className="h-[300px] rounded-xl overflow-hidden map-container" data-testid="property-map">
                    <Map zoom={15} center={mapCenter} mapId="property-detail-map">
                      <AdvancedMarker position={mapCenter}>
                        <Pin background="#3498DB" glyphColor="#FFFFFF" borderColor="#2980B9" />
                      </AdvancedMarker>
                    </Map>
                  </div>
                </APIProvider>
